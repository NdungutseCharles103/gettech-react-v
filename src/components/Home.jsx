    ...
    <div className="main ">
      ...
      <div className="cat flex flex-col items-center mt-3">
        ...
        <div className="grid gap-4 auto-col grid-cols-5">
          <div className="card justify-between cursor-pointer hover:scale-110 duration-300 shadow-xl
            mt-3 flex gap-3 flex-col items-center px-2">
            <img className="w-full"
              src={require("../Images/intro.png")} alt=""/>
            <p>Home Appliances</p>  
          </div>
          <div className="card justify-between cursor-pointer hover:scale-110 duration-300 shadow-xl
            mt-3 flex flex-col items-center px-2">
            <img className="w-full"
              src={require("../Images/gaming.jpg")} alt=""/>
            <p>Gaming</p>  
          </div>
          <div className="card justify-between cursor-pointer hover:scale-110 duration-300 shadow-xl
            mt-3 flex flex-col items-center px-2">
            <img className="w-full"
              src={require("../Images/phone-pc.jpg")} alt=""/>
            <p>Phones and Pcs</p>  
          </div>
          <div className="card justify-between cursor-pointer hover:scale-110 duration-300 shadow-xl
            mt-3 flex flex-col items-center px-2">
            <img className="w-full"
              src={require("../Images/acess.jpg")} alt=""/>
            <p>Accesories</p>  
          </div>
          <div className="card justify-between cursor-pointer hover:scale-110 duration-300 shadow-xl
            mt-3 flex flex-col items-center px-2">
            <img className="w-full"
              src={require("../Images/others.jpg")} alt=""/>
            <p>Others</p>  
          </div>
        </div>
      </div>
